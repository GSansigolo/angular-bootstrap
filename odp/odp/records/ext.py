...
"""Flask extension for Open Data Plataform."""
...
class OpenDataPlataform(object):
    """Open Data Plataform extension."""
    ...
    def init_config(self, app):
        ...
        with_endpoints = app.config.get(
            'ODP_ENDPOINTS_ENABLED', True)
        for k in dir(config):
            if k.startswith('ODP_'):
